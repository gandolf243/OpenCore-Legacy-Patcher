...
This time Apple dropped surprisingly few amount of Macs. With the release of OpenCore Legacy Patcher 3.0.0, early support for macOS Tahoe has been implemented.
